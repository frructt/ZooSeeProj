...
public class CustomAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.tvname.setText("Animal: "+userModelArrayList.get(position).getName());
        holder.tvhobby.setText("Origin: "+userModelArrayList.get(position).getHobby());
        holder.tvcity.setText("Country: "+userModelArrayList.get(position).getCity());
